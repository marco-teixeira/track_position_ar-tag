...
rospy.init_node('m03', anonymous=False, log_level=rospy.INFO, disable_signals=False)
...
while not rospy.is_shutdown():
	...
	markers.ns = "my_namespace0";
    	markers.id = 1;
	markers.type = 9;
	markers.action = Marker().ADD
	# Set the pose of the marker.  This is a full 6DOF pose relative to the frame/time specified in the header
	markers.pose.position.x = -68.5;
	markers.pose.position.y = -8.52;
