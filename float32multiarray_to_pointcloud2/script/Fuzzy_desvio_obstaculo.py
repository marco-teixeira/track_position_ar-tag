...
rule1 = ctrl.Rule(entradaY['Muito Esquerda'], saidaAngular['average'])
rule2 = ctrl.Rule(entradaY['Esquerda'], saidaAngular['average'])
rule3 = ctrl.Rule(entradaY['Centro'], saidaAngular['poor'])
rule4 = ctrl.Rule(entradaY['Direita'], saidaAngular['decent'])
rule5 = ctrl.Rule(entradaY['Muito Direita'], saidaAngular['decent'])
